...
.v-wpkt {
  ...
  & .v-header-section {
    & .c-internal-header {
      ...
      &:after {
        content: '';
        background-image: url(/img/wpkt-header-bg.jpeg);
  ...
  &-section__buy {
    ...
    @include for-width(-laptop) {
      padding:rem(55) 0 rem(75);
    }
    @include for-width(-small-lg) {
      padding:rem(35) 0 rem(50);
    }
    & .v-wpkt-section__text_long {
      max-width:35%;
      @include for-width(-tablet) {
        max-width:50%;
      }
