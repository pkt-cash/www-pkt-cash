...
.v-about {
  ...
  &-section {
    & .container_narrow {
      ...
      @include for-width(-small-lg) {
        margin-top:-35vw;
        padding:rem(35) rem(20) rem(65);
        width:calc(100% - 40px);
      }
      &::before {
        content:'';
        background:url(/img/letter-logo.jpg);
    ...
    & hr {
      height:1px;
      background:$light_grey_new;
      width:rem(235);
      max-width:60%;
      margin:rem(45) auto rem(55);
      @include for-width(-small-lg) {
        width:rem(90);
        margin:rem(20) auto;
      }
