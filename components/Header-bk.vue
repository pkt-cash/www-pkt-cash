          ...
          <ul class="nav__menu-list" :class="{ active: nav_open }">
            ...
            >
              <template v-if="item.dropdown === true">
                <a class="nav__menu-link btn-nav dropdown-toggle" @click="show = show === index ? null : index" :class="{ active: show, mClass}">
            ...
            <li class="nav_additional">
              ...
              <a href="https://packetscan.io/" target="_blank" class="c-navigation__top_links__link_border">Explorer</a>
            </li>
          </ul>
        </div>
        <div
