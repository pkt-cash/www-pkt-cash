export default {
    header: {
        ...
        origin_story: "PKT История происхождения",
    ...
    footer: {
        ...
        setup_pktcrypt: "Настройка PacketCrypt",
        about: "О нас",
        git: "Github",
    ...
    home: {
        ...
        meta_descr: "Первый в мире блокчейн-протокол на базе пропускной способности сети.",
        header_heading: "The world’s first bandwidth-hard blockchain",
        index_1: "Пропускная способность сети",
        index_1_metric: "Mb/s",
        index_2: "Сложность",
        index_3: "Уже добыто",
        index_4: "Кодирование / Сек",
        index_5: "Награда за блок",
        index_6: "Осталось монет",
        adv_text_1: "Network Steward это адрес, который получает 20% от каждого нового блока, чтобы разработчики могли финансировать построение технологии узловой сети. В отличие от предварительного взноса или взноса учредителя, получатель платежа управляющего сетью может быть изменен голосованием PoS.",
        ...
        scroll_section_descr: "Первый в мире блокчейн-протокол на базе пропускной способности сети, созданный для стимулирования роста инфраструктуры.",
        scroll_section_button_label: "More Details",
        scroll_section_block_1_title: "Сеть PKT",
        scroll_section_block_1_descr: "PKT - это блокчейн, предназначенный для создания децентрализованного рынка на базе пропускной способности сети с использованием практически бесплатных микро-транзакций и искусственного спроса на пропускную способность с использованием алгоритма bandwidth-hard подтверждения выполнения работы PacketCrypt",
        ...
        scroll_section_block_3_descr: "Обычно майнеры используют время простоя процессора, чтобы сгенерировать небольшие сообщения, называемые объявлениями, и транслировать их майнерам блоков, которые платят за них. ",
        scroll_section_block_4_title: "Майнинг блоков",
        scroll_section_block_4_descr: "Опытные майнеры используют специализированное оборудование для обеспечения безопасности блокчейна, но алгоритм PacketCrypt позволяет им уменьшить объем работы при большом количестве объявлений, эффективно заменяя пропускную способность на электроэнергию. \n",
        scroll_section_block_5_title: "PKT Cash",
        scroll_section_block_5_descr: "PKT - это локализованная криптовалюта, основанная на коде Биткойна, что делает Lightning Network готовой к работе с первого дня. Это не токен, поэтому нет ни централизованного эмитента, ни платы за газ. \n",
        ...
        feature_1_descr: "AВыделение пропускной способности сети необходимо для получения награды за майнинг.",
        feature_2_title: "Сетевой эффект",
        feature_2_descr: "Чем больше подключенных узлов, тем быстрее сеть.",
        feature_3_title: "Масштабируемость",
        feature_3_descr: "Удовлетворяет требованиям операторов сети и поставщиков инфраструктуры.",
        join_community_title: "Присоединяйтесь к сообществу",
        join_community_text: "PKT управляется сообществом для сообщества. Сеть становится более безопасной, когда она населена такими же людьми, как и Вы. Присоединяйтесь к сообществу сейчас для получения обновлений и обсуждения того, как участвовать в этой растущей сети.",
        join_community_label_link: "Присоединиться",
    },
    about: {
        ...
        about_main__btn: "PKT План развития",
    ...
    cash: {
        meta_title: "Cash - PKT",
        page_subtitle: "PKT выплачивается майнерам PacketCrypt",
        adv_subtitle: "Network Steward получает 20% от каждой монетарной транзакции",
        adv_text: "Network Steward  - это адрес, который получает 20% от каждого нового блока,  с целью финансирования разработчиками создания интернет-инфраструктуры и технологии узловых сетей. В отличие от пред-майнинговой выплаты или платы учредителя, получатель платежа управляющего сетью может быть изменен с помощью голосования по PoS.",
        main_text_1: "PKT - это локальный блокчейн, основанный на коде биткойна.  \n" +
        "Он имеет время блока в 1 минуту, использует алгоритм подтверждения работы PacketCrypt и имеет адрес Network Steward \n" +
        "который получает 20% от каждой исходной монетарной транзакции. \n" +
        "В общей сложности будет добыто 6 миллиардов PKT, и вместо того, чтобы резко сокращать выплаты каждые 4 года, \n" +
        "PKT использует устойчивый распад в 10% каждые 100 дней.",
        main_text_2: "ак как PKT предназначен для микро-транзакций, в общей сложности будет добыто 6 миллиардов PKT, \n" +
        "в то время как максимальный объем добычи биткоина составит 21 миллион. \n" +
        "Кроме того, каждый PKT подразделяется на 1 073 741 824 единицы (от 2 до 30-й степени), \n" +
        "в то время как на один биткоин приходится всего 100 миллионов сатоши. \n" +
        "Когда цена Bitcoin достигла почти $42 000 в январе 2021 года, цена сатоши составляла 0,04 цента. \n" +
        "Эта цена за сатоши непрактична для микротранзакций, даже при почти бесплатных сделках в Lightning Network.",
        main_text_3: "PKT разработан на основе идеи быстрых дешевых транзакций небольшого номинала, чтобы обеспечить пропускную способность торгового рынка. \n" +
        "PKT обеспечивает экономический стимул для подключения людей к сети. Network Steward предназначен для обеспечения финансирования для создания децентрализованной интернет-инфраструктуры и технологии с открытым исходным кодом.",
        main_caption: "Выплата PKT vs. BTC как процент от общего количества монет",
    },
    community: {
        meta_title: "Сообщество - PKT",
        resources_list_title: "Торговая группа PKT",
        resources_list_text: "Сообщество организовало чат в Telegram для покупки и продажи PKT по принципу \"равный-равному\".",
        big_header_title: "Сообщество",
        big_header_subtitle: "Спасибо за ваш интерес к сети PKT. В построении этой сетевой инфраструктуры мы сильны лишь как сумма всех частей.",
        big_header_text: "Пожалуйста, ознакомьтесь с имеющимися различными ресурсами для сотрудничества и общения.",
        resources_title: "Ресурсы",
        resources_text: "Участвуйте в Торговой группе PKT для поиска сторон купли-продажи для обеспечения ликвидности PKT. Этот ресурс открыт для общественности с целью инициации торгов PKT.",
        join_title: "Присоединяйтесь к нам",
        join_text: "Присоединяйтесь к нам и помогите создать лучший интернет. Подключайтесь и сотрудничайте с членами сообщества PKT онлайн",
        join_list_item_title_1: "PKT.chat - Чат проекта",
        join_list_item_text_1: "TМесто, где можно общаться с разработчиками ядра PKT, получить помощь и поддержку, а также приобщиться к проекту.",
        join_list_item_title_2: "PKT Cash - Обсуждение в сообществе",
        join_list_item_text_2: "Сообщество организовало чат для обсуждения проекта PKT",
        join_list_item_title_3: "PKT Сообщество Discord",
        join_list_item_text_3: "Универсальная платформа для обсуждения всего, что связано с PKT. Задавайте вопросы лидерам сообщества и о том, где можно принять участие в работе PKT Network.",
        join_list_item_title_4: "Twitter",
        join_list_item_text_4: "Следите за PKT на Twitter, чтобы быть в курсе новостей и достижений.",
        join_list_item_title_5: "IRC",
        join_list_item_text_5: "Следите за главным чатом PKT.chat через закрытый IRC канал",
        join_list_item_title_6: "Matrix",
        join_list_item_text_6: "Следите за главным чатом PKT.chat через закрытый канал Matrix",
    },
    mining: {
        meta_title: "Майнинг - PKT",
        header_titletext: "Первое в мире bandwidth-hard подтверждения выполнения работы",
        header_buttons_title: "Для старта майнинга вам нужно",
        header_button_2: "Установить PacketCrypt",
        adv_subtitle_1: "Packet + Crypt = пропускная способность + шифрование",
        adv_text_1: "PacketCrypt - это алгоритм, предназначенный для поощрения сотрудничества между майнерами и инвестиций в интернет-инфраструктуру для высокоскоростного шифрования и дешифрования данных. Эффективный майнинг возможен только в том случае, если майнеры общаются друг с другом, и для этого требуется расход пропускной способности вместо усилий процессора. В результате получается bandwidth-hard PoW, который сочетает в себе 2 отдельных этапа: майнинг объявлений и майнинг блоков, которые вместе децентрализуют передачу данных в распределенную глобальную сеть.",
        adv_subtitle_2: "Все могут майнить объявления",
        adv_text_2: "На стадии объявления майнер создает небольшое (1KB) сообщение, которое доказывает, что он выполнил определенную работу. Объявления затем собираются майнерами блоков для формирования блоков. Майнеры объявлений стремятся максимизировать количество успешных объявлений, которые могут быть приняты в блок и должны максимизировать свою пропускную способность для достижения оптимальных результатов майнинга. Это, в свою очередь, гарантирует высокую пропускную способность сети в продольном направлении. Объявление, по умолчанию, является состоянием сети узлов. Но объявление может быть любым битом данных.",
        adv_button_2: "Начать майнить",
        adv_subtitle_3: "Для майнинга блоков требуется специализированное оборудование",
        adv_text_3: "Майнинг блоков - это вторая стадия, а майнеры блоков - это традиционные \"майнеры\" в понимании блокчейна, так как они валидируют цепочку и получают выплаты. Майнеры блоков собирают объявления от майнеров объявителей. Майнеры блоков получают скидку за сложность работы, которую они должны выполнять, исходя из количества новых объявлений, которые они собирают, поэтому они мотивированы получать много объявлений во время майнинга и платить майнерам за их поставки.",
    },
    contact: {
    ...
    roadmap: {
        meta_title: "План развития - PKT",
        roadmap_is_heading: "План развития PKT",
        ...
        phase_2_subtitle: "Токензированная аренда пропускной способности",
        ...
        phase_3_pre: "Фаза 3",
        phase_3_title: "Scale",
        phase_3_subtitle: "Поддержка совместного использования Интернета",
    ...
    steward: {
        ...
        big_header_text: "20% от каждого нового блока идет на адрес сетевого управляющего. Этот адрес может быть изменен с помощью голосования на основе PoS. Смотрите раздел голосования за управляющего для получения дополнительной информации о механике голосования. Платежи сетевому управляющему имеют одно особое правило, они не могут быть потрачены по истечении 129600 блоков (приблизительно 3 месяца), так что если сетевой управляющий не может решить, как потратить свою казну, то PKT сгорят, а не будут накоплены.",
        network_nav_01: "Устав Network Steward",
        network_nav_02: "Предложение на финансирование",
        network_nav_03: "Проекты Network Steward",
        network_nav_04: "Кто такой Network Steward",
        network_01_content_01: "Целью Network Steward является снижение барьеров для входа, чтобы поддержать сеть PKT в стремлении к большей индивидуальной автономии и конфиденциальности",
        network_01_content_02: "Ключевые аспекты этой цели включают в себя:",
        network_01_content_03: "Финансирование разработки сетевого программного обеспечения с открытым исходным кодом",
        network_01_content_04: "Лоббирование улучшения нормативной среды для мелких операторов сетей и в более общем плане - свободы Интернета, конфиденциальности и децентрализации",
        network_01_content_05: "Приобретение имущества, такого как проприетарное программное обеспечение или права на радиочастотный спектр, с целью их передачи  в общественное пользование",
        network_01_content_06: "Для достижения этих целей, управляющий сетью будет время от времени проводить встречи для рассмотрения заявок на финансирование и выбора проектов, на реализацию которых PKT будет выделять средства.",
        network_02_content_01: "Как подать предложение на финансирование",
        network_02_content_02: "Подача предложения во многом похожа на процесс объединения запроса на включение в проект. Вы начинаете с общения с сообществом (попробуйте IRC или чаты Matrix), и когда у вас есть примерный консенсус, вы переносите этот разговор в формальное предложение.",
        network_02_content_03: "Чтобы сделать предложение, вы должны создать запрос на включение в репозиторий ns-projects, который добавит новый файл разметки проекта в соответствии с шаблоном проекта, и дать ему имя в соответствии с соглашением об именах, определенным в readme репозитория.",
        network_02_content_04: "Периодически управляющий сетью будет проводить совещания и принимать решение о том, какие предложения должны быть профинансированы. Протоколы этих встреч публикуются в репозитории ns-projects вместе с проектами и их статусом.",
        network_02_content_05: "Внести предложение",
        network_02_content_06: "Скачать шаблон",
        network_03_content_01: "Это различные проекты:",
        network_04_content_01: "Network Steward  - это кошелек с несколькими подписями, который требует 3 из 5 подписей для того, чтобы произвести платеж.",
        network_04_content_02: "Адрес кошелька Network Steward:",
        network_04_content_03: "cjd - автор оригинала cjdns",
        network_04_content_04: "Arceliar - автор оригинала Yggdrasil",
        network_04_content_05: "benhylau - контрибьютор Toronto Mesh",
        network_04_content_06: "NeilAlexander - релиз-менеджер Yggdrasil",
        network_04_content_07: "Backupbrain - создатель NetNinja VPN device",
        network_04_content_08: "Все участники соглашаются не вступать в какие-либо отношения, которые могли бы повлиять на их способность действовать беспристрастно от имени PKT.",
        network_04_content_09: "Детали голосования",
    },
    steward_vote: {
    ...
    wallet: {
        ...
        header_descr: "Здесь вы храните свои PKT.",
        header_button: "Setup a Wallet",
        wallet_list_item_1: "Отправляйте, получайте и зарабатывайте PKT.",
        wallet_list_item_2: "Управляйте своими приватными ключами.",
        wallet_list_item_3: "Сделайте резервную копию своего кошелька, написав короткое сообщение из 13 слов.",
        options_heading: "В настоящее время есть два варианта получения бесплатного PKT кошелька",
        option_01_title: "Кошелек с командной строкой",
        option_01_descr: "Полная настройка узла на базе терминала",
        option_01_button: "Настроить CLI кошелек",
        option_02_title: "Электронный PKT кошелек",
        option_02_descr: "Кошелек с графическим интерфейсом (GUI) для настольного ПК",
        option_02_button: "Настроить электронный кошелек",
