export default {
    header: {
        ...
        letter: "Lettre du CJD",
        origin_story: "Histoire de l'origine de PKT",
    ...
    footer: {
        ...
        setup_pktcrypt: "Configuration de PacketCrypt",
        about: "À propos",
        git: "Github",
        policy: "Politique de confidentialité",
        join_community: "Rejoindre la communauté",
        network_steward_voting: "Vote de Network Steward",
        origin_story: "Histoire de l'origine",
        trademark: "Marque",
        brand: "Brand",
        pkt_chat: "pkt.chat",
        twitter: "Twitter",
    ...
    home: {
        meta_title: "PKT Cash - Internet toujours accessible",
        meta_descr: "Le premier protocole blockchain résistant à la bande passante au monde, conçu pour encourager la croissance de l'infrastructure.",
        header_heading: "L'AVENIR DE L'ACCÈS À INTERNET",
        header_subheading_1: "PKT est un écosystème d'applications qui décentralisent l'accès à Internet.",
        header_subheading_2: "La mission est de connecter la prochaine milliard de personnes à Internet.",
        index_1: "Bande passante du réseau / seconde",
        index_1_metric: "Mb/s",
        index_2: "Difficulté",
        index_3: "Extrait à ce jour",
        index_4: "Chiffrements / seconde",
        index_5: "Récompense actuelle par bloc",
        index_6: "Pièces restantes",
        ...
        scroll_section_descr: "Le premier protocole blockchain résistant à la bande passante au monde, conçu pour encourager la croissance de l'infrastructure",
        ...
        scroll_section_block_5_descr: "PKT est une cryptomonnaie native basée sur le code Bitcoin, ce qui la rend prête pour le Lightning Network dès le premier jour. Ce n'est pas un jeton, il n'y a donc pas d'émetteur centralisé et pas de frais de gaz.",
        ...
        feature_1_title: "Bande passante exigeante",
        feature_1_descr: "Allouer de la bande passante réseau est nécessaire pour gagner des récompenses de minage.",
        feature_2_title: "Mise en réseau",
        feature_2_descr: "Plus il y a de nœuds connectés, plus le réseau devient rapide.",
        feature_3_title: "Évolutivité",
        feature_3_descr: "Répond aux besoins des opérateurs réseau et des fournisseurs d'infrastructure.",
        join_community_title: "Rejoignez la communauté",
        join_community_text: "PKT est géré par la communauté, pour la communauté. Le réseau devient plus sécurisé lorsqu'il est peuplé de personnes comme VOUS. Rejoignez la communauté dès maintenant pour des mises à jour et des discussions sur la manière de participer à ce réseau en pleine croissance.",
        join_community_label_link: "Rejoignez maintenant",
        roadmap_link: "Feuille de route",
        subtitle: "BIENVENUE CHEZ PKT",
        title: "Internet Par Les Gens, Pour Les Gens",
        content_1: "PKT est le seul protocole de couche 1 conçu pour transmettre des données à grande vitesse dans le monde entier et permettre l'accès à Internet sans dépendre d'un fournisseur d'accès traditionnel monopolistique.",
        content_2: "PKT sépare les rôles techniques des rôles physiques des services Internet, de sorte que quiconque peut soit être rémunéré pour fournir Internet dans son quartier en tant que point d'accès, soit faciliter des services en ligne techniques en tant que fournisseur de services cloud.",
        link_1: "Qu'est-ce qu'un fournisseur de services cloud",
        link_2: "Devenir un point d'accès",
        mining_data_title: "Mainnet",
        mining_data_subtitle: "En direct",
        cp_logins_label: "Utilisateurs totaux du réseau",
        bandwidth: "Bande passante du réseau / seconde",
        mined: "Miné par jour",
        encryptions: "Chiffrements / seconde",
        pkt_price: "Prix du PKT",
        block_1_title: "Construire",
        block_1_subtitle: "L'avenir des réseaux",
